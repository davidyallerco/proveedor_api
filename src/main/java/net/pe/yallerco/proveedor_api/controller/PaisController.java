...
//	}
	...
	//Header
	@GetMapping("/listar-con-headers")
    public ResponseEntity<Map<String, String>> getAllPaisesWithHeaders(
            @RequestHeader Map<String, String> headers) {

        // Puedes inspeccionar los headers aquí
        System.out.println("Headers recibidos en Spring Boot:");
        headers.forEach((key, value) -> System.out.println(key + " = " + value));

        // Devuelve los headers en la respuesta
        // Spring Boot automáticamente serializará el Map a JSON
